...
{
  "tenant_names": "Full name(s). If joint tenancy, separate with ' and '",
  ...
  "parking": "Not included OR details like space number and location",
  "special_conditions": "Full text if present, or null if none exist",
