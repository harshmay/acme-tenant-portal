...

{
  ...
  "special_conditions": "Full text of any special conditions if present. Return null if the lease says Nil, None, N/A, or no special conditions. Never return null as a string.",
  "parking_included": "Return ONLY 'Not included' if no parking is provided. If parking is included, describe it briefly (e.g. 'Basement Level 1, Space #47'). Never copy the full sentence from the lease.",
